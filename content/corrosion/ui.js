...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'bin/release/emscripten/ui.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_bin/release/emscripten/ui.data');

      };
      Module['addRunDependency']('datafile_bin/release/emscripten/ui.data');
    ...
    loadPackage({"files": [{"filename": "/stylesheet.dt", "start": 0, "end": 356}], "remote_package_size": 356});
